...
gen-check: ## Verify generator output still compiles
	...
	@set -e; \
	  ...
	  awk '1; /"github.com\/libtnb\/chi-skeleton\/internal\/order"/ { print "\t\"github.com/libtnb/chi-skeleton/internal/gencheck\"" }' internal/app/wire.go > internal/app/wire.go.tmp; \
